...
Vue.component('img-lazy', {
    ...
    methods: {
            ...
            var lazyLoad = function () {
                ...
                setTimeout(function () {
                    ...
                    lazyImages.forEach(function (lazyImage) {
                        // 判断元素是否进入viewport
                        if (_this.isInViewport(lazyImage)) {
        ...
        isInViewport: function (ele) {
            ...
            // 元素display样式不为none
            var notBelow = ele.getBoundingClientRect().top <= window.innerHeight ? true : false;
            var notAbove = ele.getBoundingClientRect().bottom >= 0 ? true : false;
            var visable = getComputedStyle(ele).display !== "none" ? true : false;
